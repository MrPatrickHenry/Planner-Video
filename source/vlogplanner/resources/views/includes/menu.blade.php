<div class="btn-group">
    <button class="btn dropdown-toggle waves-effect waves-light" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Upcoming Events <i class="fa fa-calendar-o" aria-hidden="true"></i></button>

    <div class="dropdown-menu">
     <ul>
     <li ng-repeat="x in events">
     <a  href="/events/@{{ x.EventSlug }}">@{{ x.EventName }}</a>
</li>
</ul>
    </div>
</div>
